...
In order to support loading of multiple wallets in coffee-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is coffee.cpp.
...
Changes to coffee.cpp
----------------------
coffee.cpp is the entry point into coffee-qt, and as such, will require some minor modifications to provide hooks for
