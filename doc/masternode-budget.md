...
Coffee now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<coffee_address\> \<monthly_payment_coffee\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ CFE, _12_ times over the course of a year totaling _24000_ CFE.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<coffee_address\> \<monthly_payment_coffee\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` CFE.
 ...
 * vote-many          - Vote on a Coffee initiative
 * vote-alias         - Vote on a Coffee initiative
 * vote               - Vote on a Coffee initiative/budget
