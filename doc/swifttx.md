...
This mechanism has been integrated into Bitcore-Node-Coffee which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/coffee/insight-api-coffee#web-socket-api](https://github.com/coffee/insight-api-coffee#web-socket-api)
* API: [https://github.com/coffee/insight-api-coffee#swifttx-transactions](https://github.com/coffee/insight-api-coffee#swifttx-transactions)
...
By default, the Coffee Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Coffee Core daemon:
