...
/** Utility functions used by the Coffee Qt UI.
 */
namespace GUIUtil
{
...
// Render CFE addresses in monospace font
...
// Parse "coffee:" URI into recipient object, return true on successful parsing
