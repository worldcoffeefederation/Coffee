                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Coffee Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CFE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and coffee: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Coffee Core"), this);
    aboutAction->setStatusTip(tr("Show information about Coffee Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Coffee"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CFE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CFE addresses"));
    ...
    openAction->setStatusTip(tr("Open a coffee: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Coffee Core help message to get a list with possible Coffee command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Coffee Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Coffee network", "", count));
}
...
{
    QString strTitle = tr("Coffee Core"); // default title
