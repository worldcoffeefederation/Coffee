...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Coffee features */
        {"coffee", "masternode", &masternode, true, true, false},
        {"coffee", "listmasternodes", &listmasternodes, true, true, false},
        {"coffee", "getmasternodecount", &getmasternodecount, true, true, false},
        {"coffee", "masternodeconnect", &masternodeconnect, true, true, false},
        {"coffee", "masternodecurrent", &masternodecurrent, true, true, false},
        {"coffee", "masternodedebug", &masternodedebug, true, true, false},
        {"coffee", "startmasternode", &startmasternode, true, true, false},
        {"coffee", "createmasternodekey", &createmasternodekey, true, true, false},
        {"coffee", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"coffee", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"coffee", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"coffee", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"coffee", "getmasternodescores", &getmasternodescores, true, true, false},
        {"coffee", "mnbudget", &mnbudget, true, true, false},
        {"coffee", "preparebudget", &preparebudget, true, true, false},
        {"coffee", "submitbudget", &submitbudget, true, true, false},
        {"coffee", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"coffee", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"coffee", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"coffee", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"coffee", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"coffee", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"coffee", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"coffee", "checkbudgets", &checkbudgets, true, true, false},
        {"coffee", "mnsync", &mnsync, true, true, false},
        {"coffee", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> coffee-cli " + methodname + " " + args + "\n";
}
