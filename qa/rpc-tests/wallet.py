...
#   c) node1 mines 32 blocks, so now node 0 has 500000CFE, node 1 has 4250CFE, node2 has none.
#   d) node0 sends 601 CFE to node2, in two transactions (301 CFE, then 300 CFE).
