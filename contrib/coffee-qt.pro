...
RESOURCES += src/qt/coffee.qrc src/qt/coffee_locale.qrc

TRANSLATIONS += src/qt/locale/coffee_bg.ts \
                src/qt/locale/coffee_de.ts \
                src/qt/locale/coffee_en.ts \
                src/qt/locale/coffee_es.ts \
                src/qt/locale/coffee_fi.ts \
                src/qt/locale/coffee_fr.ts \
                src/qt/locale/coffee_it.ts \
                src/qt/locale/coffee_ja.ts \
                src/qt/locale/coffee_pl.ts \
                src/qt/locale/coffee_pt.ts \
                src/qt/locale/coffee_ru.ts \
                src/qt/locale/coffee_sk.ts \
                src/qt/locale/coffee_sv.ts \
                src/qt/locale/coffee_vi.ts \
                src/qt/locale/coffee_zh_CN.ts \
                src/qt/locale/coffee_zh_TW.ts
