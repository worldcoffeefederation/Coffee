Contributing to Coffee Core
==================================

The Coffee Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Coffee Core project, and is not to be
confused with overall Coffee Network Protocol consensus changes.

Whether a pull request is merged into Coffee Core rests with the project merge
...
Patches that change Coffee consensus rules are considerably more involved than
...
Where a patch set proposes to change the Coffee consensus, it must have been
...
The project leader is the release manager for each Coffee Core release.
